...
var TornadoWebSocketModule = function () {
    function TornadoWebSocketModule(websocket) {
        var prefix = arguments.length <= 1 || arguments[1] === undefined ? '' : arguments[1];

        _classCallCheck(this, TornadoWebSocketModule);
    ...
    _createClass(TornadoWebSocketModule, [{
        key: 'on',
        value: function on(event, callback) {
